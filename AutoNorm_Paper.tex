...
\subsubsection{Relationship to Conditional Normalization}
AutoNorm shares conceptual roots with conditional normalization techniques like FiLM \cite{perez2018film} and AdaBN \cite{li2018adaptive}. However, unlike FiLM which often requires external conditioning signals, AutoNorm utilizes purely internal feature statistics via Gumbel-Softmax gating to make autonomous, layer-wise decisions. This distinguishes it as a self-adaptive meta-learning framework.
